-- ===========================================
-- CORREÇÃO ALTERNATIVA: SEM CONSTRAINT ÚNICA
-- ===========================================
...
-- 3. ATUALIZAR FUNÇÃO PROCESS_GROUP_PAYMENT (SEM CONSTRAINT)
-- ===========================================
...
-- Verificar se constraint problemática foi removida
SELECT 
    'Constraint problemática removida' as teste,
    CASE 
        WHEN COUNT(*) = 0 THEN '✅ SIM'
...
SELECT 
    ...
    'Agora verifica logicamente se já existe membership ativo' as detalhe;
...
SELECT 
    '✅ Sem constraint única' as status,
    'Usa apenas lógica na função para evitar duplicatas' as detalhe; 