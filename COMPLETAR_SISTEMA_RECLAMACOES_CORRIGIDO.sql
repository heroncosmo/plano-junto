-- ===========================================
-- COMPLETAR SISTEMA DE RECLAMAÇÕES - CORRIGIDO
...
-- View para mensagens com dados do usuário (CORRIGIDO - sem avatar_url)
...
-- Função para notificar admin sobre nova reclamação (CORRIGIDO)
CREATE OR REPLACE FUNCTION public.notify_admin_new_complaint()
RETURNS TRIGGER AS $$
BEGIN
    -- Inserir na tabela de notificações com estrutura correta
...
-- ===========================================
-- SISTEMA DE RECLAMAÇÕES COMPLETADO COM SUCESSO!
-- ===========================================
