-- ===========================================
-- CORREÇÃO DA FUNÇÃO PROCESS_GROUP_PAYMENT
-- ===========================================

-- Função corrigida para processar pagamento de grupo
...
SELECT 
    'Função process_group_payment corrigida' as teste,
    CASE 
...
SELECT 
    'Constraint única group_memberships' as info,
    constraint_name,
    constraint_type
