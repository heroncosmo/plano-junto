-- ===========================================
-- TESTE FINAL DO SISTEMA DE CANCELAMENTO
-- ===========================================
...
-- Teste 2: Dashboard - Grupos como admin (deve filtrar apenas 'active')
SELECT 
...
-- 6. TESTAR FUNÇÃO DE CANCELAMENTO (se houver dados)
-- ===========================================
...
-- 7. VERIFICAR RESTRIÇÕES DE USUÁRIO
-- ===========================================
...
SELECT 
    ...
    'Queries filtram apenas status = active' as detalhe; 