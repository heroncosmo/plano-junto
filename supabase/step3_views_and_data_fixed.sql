-- ===========================================
-- PASSO 3 CORRIGIDO: VIEWS E NOVOS SERVIÇOS
...
-- Adicionar novos serviços (usando WHERE NOT EXISTS para evitar duplicatas)
...
) AS new_services(name, category, max_users, pre_approved, icon_url)
WHERE NOT EXISTS (
