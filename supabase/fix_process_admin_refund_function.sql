-- ========================================
-- CORREÇÃO: FUNÇÃO PROCESS_ADMIN_REFUND
-- ========================================
-- Este script corrige a função process_admin_refund para
-- usar o nome correto da coluna price_per_slot_cents
...
-- 2. Recriar a função com o nome correto da coluna
...
SELECT 'Função process_admin_refund corrigida com nome correto da coluna!' as status; 