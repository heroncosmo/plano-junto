...
const AdminDashboard = () => {
  ...
  return (
    <div className="p-6">
      {/* Layout principal: esquerda (visão geral + ações) e direita (informações do sistema) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Coluna esquerda: Visão Geral + Cards + Ações Rápidas */}
        <div className="lg:col-span-2 space-y-6">
          <div className="mb-2">
            <h2 className="text-xl font-semibold text-gray-900 mb-1">Visão Geral do Sistema</h2>
            <p className="text-gray-600 text-sm">Estatísticas gerais do JuntaPlay</p>
          </div>
